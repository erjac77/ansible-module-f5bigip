...
def main():
    module = AnsibleModuleF5BigIpNamedObject(argument_spec=BIGIP_LTM_PROFILE_WEB_ACCELERATION_ARGS, supports_check_mode=False)

    try:
        obj = F5BigIpLtmProfileWebAcceleration(check_mode=module.supports_check_mode, **module.params)
        result = obj.flush()
