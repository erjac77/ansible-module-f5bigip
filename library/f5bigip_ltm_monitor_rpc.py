...
class F5BigIpLtmMonitorRpc(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.ltm.monitor.rpcs.rpc.create,
            'read': self._api.tm.ltm.monitor.rpcs.rpc.load,
            'update': self._api.tm.ltm.monitor.rpcs.rpc.update,
            'delete': self._api.tm.ltm.monitor.rpcs.rpc.delete,
            'exists': self._api.tm.ltm.monitor.rpcs.rpc.exists
        }
...
def main():
    ...
    try:
        obj = F5BigIpLtmMonitorRpc(check_mode=module.check_mode, **module.params)
        result = obj.flush()
