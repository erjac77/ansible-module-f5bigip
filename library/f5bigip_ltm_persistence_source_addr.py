...
def main():
    module = AnsibleModuleF5BigIpNamedObject(argument_spec=BIGIP_LTM_PERSISTENCE_SOURCE_ADDR_ARGS,
                                             supports_check_mode=True)

    try:
        obj = F5BigIpLtmPersistenceSourceAddr(check_mode=module.check_mode, **module.params)
        result = obj.flush()
