...
class F5BigIpLtmProfileRequestAdapt(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.ltm.profile.request_adapts.request_adapt.create,
            'read': self._api.tm.ltm.profile.request_adapts.request_adapt.load,
            'update': self._api.tm.ltm.profile.request_adapts.request_adapt.update,
            'delete': self._api.tm.ltm.profile.request_adapts.request_adapt.delete,
            'exists': self._api.tm.ltm.profile.request_adapts.request_adapt.exists
        }
