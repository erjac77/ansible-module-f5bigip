...
class F5BigIpLtmMonitorPostgresql(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.ltm.monitor.postgresqls.postgresql.create,
            'read': self._api.tm.ltm.monitor.postgresqls.postgresql.load,
            'update': self._api.tm.ltm.monitor.postgresqls.postgresql.update,
            'delete': self._api.tm.ltm.monitor.postgresqls.postgresql.delete,
            'exists': self._api.tm.ltm.monitor.postgresqls.postgresql.exists
        }
