...
class F5BigIpLtmMonitorMysql(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.ltm.monitor.mysqls.mysql.create,
            'read': self._api.tm.ltm.monitor.mysqls.mysql.load,
            'update': self._api.tm.ltm.monitor.mysqls.mysql.update,
            'delete': self._api.tm.ltm.monitor.mysqls.mysql.delete,
            'exists': self._api.tm.ltm.monitor.mysqls.mysql.exists
        }
...
def main():
    ...
    try:
        obj = F5BigIpLtmMonitorMysql(check_mode=module.check_mode, **module.params)
        result = obj.flush()
