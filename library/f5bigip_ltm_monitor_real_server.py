...
def main():
    module = AnsibleModuleF5BigIpNamedObject(argument_spec=BIGIP_LTM_MONITOR_REAL_SERVER_ARGS,
                                             supports_check_mode=False)

    try:
        obj = F5BigIpLtmMonitorRealServer(check_mode=module.supports_check_mode, **module.params)
        result = obj.flush()
