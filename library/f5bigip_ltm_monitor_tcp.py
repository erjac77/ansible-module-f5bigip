...
class F5BigIpLtmMonitorTcp(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.ltm.monitor.tcps.tcp.create,
            'read': self._api.tm.ltm.monitor.tcps.tcp.load,
            'update': self._api.tm.ltm.monitor.tcps.tcp.update,
            'delete': self._api.tm.ltm.monitor.tcps.tcp.delete,
            'exists': self._api.tm.ltm.monitor.tcps.tcp.exists
        }
