...
class F5BigIpGtmMonitorHttp(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.gtm.monitor.https.http.create,
            'read': self._api.tm.gtm.monitor.https.http.load,
            'update': self._api.tm.gtm.monitor.https.http.update,
            'delete': self._api.tm.gtm.monitor.https.http.delete,
            'exists': self._api.tm.gtm.monitor.https.http.exists
        }
